      ...
      <div className="max-w-screen-xl mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
              ...
              {isDropdownOpen && (
                <div className="absolute left-0 mt-2 w-80  bg-white border border-gray-300 shadow-lg rounded-lg">
                  <div className="grid grid-cols-3 gap-12 p-4">
                    <div>
                      <h3 className="text-xl font-semibold text-earthy-brown">
                        Vegetable
                      </h3>
                      <ul className="mt-2 space-y-2">
                        <li>
                          <Link
                            to="/fashion/onion"
                            className="text-earthy-brown hover:text-earthy-yellow">
                            Onion
                          </Link>
                        </li>
                        <li>
            ...
            <Link to="/cart" className="relative">
              <svg
                className="w-[30px] h-[30px] fill-[#8c644a]"
                viewBox="0 0 576 512"
        ...
        {isMenuOpen && (
          <div className="md:hidden flex flex-col items-center space-y-4 mt-4">
            <Link to="/categories" className="text-lg text-earthy-brown">
              Categories
            </Link>
            <Link
              to="/seller"
            ...
            <button className="text-lg text-earthy-brown hover:text-earthy-yellow">
              Sign In
            </button>
          </div>
        )}
