...
const SubDistrictPriceCard = ({ subdistrict, avgPrice, productCount, highestPrice, lowestPrice }) => {
  return (
    <div className="bg-earthy-beige shadow-lg rounded-lg p-5 w-64 h-56 flex flex-col items-center justify-between border border-earthy-tan">
      <h3 className="text-xl font-semibold text-earthy-brown">{subdistrict}</h3>
...
export default SubDistrictPriceCard;
